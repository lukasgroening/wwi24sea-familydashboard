...
@patch("routers.calendars.fetch_external_events")
def test_get_calendar_events_success(mock_fetch, client, test_user):
    ...
    client.post("/api/calendar/sources", json={
        "name": "Test Source",
...
def test_delete_local_event_success(client, test_user):
    ...
    with patch("routers.calendars.fetch_external_events", return_value=[]):
...
def test_remove_calendar_source_success(client, test_user):
    ...
    # Create
    create_res = client.post("/api/calendar/sources", json={
        "name": "Delete Source",
